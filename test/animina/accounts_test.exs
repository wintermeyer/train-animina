defmodule Animina.AccountsTest do
  ...
  describe "register_user/1" do
    ...
    test "validates maximum values for email and password for security" do
      too_long = String.duplicate("db", 150)
  ...
  describe "change_user_registration/2" do
    ...
    test "allows fields to be set" do
      ...
      assert get_change(changeset, :gender) == gender
      ...
      assert get_change(changeset, :lang) == lang
      assert get_change(changeset, :timezone) == timezone
  ...
  describe "apply_user_email/3" do
    ...
    test "validates maximum value for email for security", %{user: user} do
      too_long = "#{String.duplicate("db", 200)}#{unique_user_email()}"
  ...
  describe "deliver_user_confirmation_instructions/2" do
    ...
    #   assert user_token = Repo.get_by(UserToken, token: :crypto.hash(:sha256, token))
    #   assert user_token.user_id == user.id
    #   assert user_token.sent_to == user.first_name
