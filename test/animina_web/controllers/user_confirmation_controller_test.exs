defmodule AniminaWeb.UserConfirmationControllerTest do
  ...
  describe "GET /users/confirm/:token" do
    ...
    #   assert redirected_to(conn) == "/"
    #   assert get_flash(conn, :info) =~ "Ihr Account wurde aktiviert. 🎉"
    ...
    #   conn = get(conn, Routes.user_confirmation_path(conn, :confirm, token))
    #   assert redirected_to(conn) == "/"
    #   assert get_flash(conn, :error) =~ "Der von Ihnen benutze Link ist ungültig oder abgelaufen."
